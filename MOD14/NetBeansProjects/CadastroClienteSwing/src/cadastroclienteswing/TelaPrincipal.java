...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void JMenuItemSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMenuItemSairActionPerformed
        int result = JOptionPane.showConfirmDialog(this,"Deseja sair da app?", "Sair", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(!isCamposValidos(nome, cpf)) {
            JOptionPane.showMessageDialog(null, "Existem campos a serem preenchidos" , "Bem Vindo!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
